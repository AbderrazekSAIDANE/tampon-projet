...
export default function PersonnalisationPage() {
  ...
  const justificatifs = location.state?.justificatifs || {};
  const { registreCommerceUrl, pieceIdentiteUrl } = justificatifs;
  ...
  return (
    <div className="p-6 space-y-4 max-w-lg mx-auto">
      ...
      {registreCommerceUrl && pieceIdentiteUrl && (
        <div className="bg-gray-100 p-4 rounded shadow">
          <p className="font-semibold mb-2">Justificatifs téléchargés :</p>
          <ul className="list-disc list-inside text-blue-600">
            <li>
              <a href={registreCommerceUrl} target="_blank" rel="noopener noreferrer">
